...
int main(int argc, char *argv[])
{
	...
	printer::inst()->print_str("  ______                                   __                 ______             __           \n");
	printer::inst()->print_str(" /      \                                 /  |               /      \           /  |          \n");
	printer::inst()->print_str("/$$$$$$  |  ______   __    __   ______   _$$ |_     ______  /$$$$$$  |  ______  $$/  _______  \n");
	printer::inst()->print_str("$$ |  $$/  /      \ /  |  /  | /      \ / $$   |   /      \ $$ |  $$/  /      \ /  |/       \ \n");
	printer::inst()->print_str("$$ |      /$$$$$$  |$$ |  $$ |/$$$$$$  |$$$$$$/   /$$$$$$  |$$ |      /$$$$$$  |$$ |$$$$$$$  |\n");
	printer::inst()->print_str("$$ |   __ $$ |  $$/ $$ |  $$ |$$ |  $$ |  $$ | __ $$ |  $$ |$$ |   __ $$ |  $$ |$$ |$$ |  $$ |\n");
	printer::inst()->print_str("$$ \__/  |$$ |      $$ \__$$ |$$ |__$$ |  $$ |/  |$$ \__$$ |$$ \__/  |$$ \__$$ |$$ |$$ |  $$ |\n");
	printer::inst()->print_str("$$    $$/ $$ |      $$    $$ |$$    $$/   $$  $$/ $$    $$/ $$    $$/ $$    $$/ $$ |$$ |  $$ |\n");
	printer::inst()->print_str(" $$$$$$/  $$/        $$$$$$$ |$$$$$$$/     $$$$/   $$$$$$/   $$$$$$/   $$$$$$/  $$/ $$/   $$/ \n");
	printer::inst()->print_str("                    /  \__$$ |$$ |                                                            \n");
	printer::inst()->print_str("                    $$    $$/ $$ |                                                            \n");
	printer::inst()->print_str("                     $$$$$$/  $$/                                                             \n");
	printer::inst()->print_str("Untraceable payments x Stable network x NO FEES x NO PREMINE\n");
	printer::inst()->print_str("Check out our Discord https://discord.gg/upPCtgcMJu\n");
	printer::inst()->print_str("-------------------------------------------------------------------\n");
